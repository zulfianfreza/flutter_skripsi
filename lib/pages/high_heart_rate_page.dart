...
class HighHeartRatePage extends StatelessWidget {
  const HighHeartRatePage({Key? key}) : super(key: key);
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                Text(
                  'Menrapkan gaya hidup sehat, seperti menjaga berat badan ideal, tetap aktif bergerak, mengurangi stress, dan menghindari rokok, merupakan beberapa cara agar jantung tetap sehat dan terhindar dari denyut jantung tinggi.\n\nJika denyut jantung tinggi terjadi secara berkelnajutan dan tidak diketahui dengan pasti apa penyebabnya, konsultasikan dengan dokter untuk mendapatkan pemeriksaan lebih lanjut.',
                  style: blackTextStyle.copyWith(
                    fontSize: 16,
                  ),
                ),
